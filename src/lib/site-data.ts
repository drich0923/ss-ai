...
export const productModules: ProductModule[] = [
  {
    ...
    heroTitle: "Review every sales call without adding more manager listening time.",
  ...
  },
  {
    ...
    heroTitle: "Give every manager a clear weekly system for coaching and accountability.",
  ...
  },
  {
    ...
    heroTitle: "See which client accounts are healthy, slipping, or putting revenue at risk.",
  ...
  },
  {
    ...
    heroTitle: "Know who owns every deal, what is collected, and where cash is still exposed.",
  ...
  },
  {
    ...
    heroTitle: "Launch clients and reps with fewer missed steps and cleaner handoffs.",
