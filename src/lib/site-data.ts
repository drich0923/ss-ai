...
export const productModules: ProductModule[] = [
  {
    ...
    heroTitle: "Review every sales call without more manager listening time.",
  ...
  },
  {
    ...
    heroTitle: "Give every manager a clear weekly coaching system.",
  ...
  },
  {
    ...
    heroTitle: "See which client accounts are slipping before revenue does.",
  ...
  },
  {
    ...
    heroTitle: "Know who owns the deal and where cash is exposed.",
